<template>
    <div>
        ...
        <div class="row" style="height: 70vh">
            <div class="col-md-3 panel" style="background: #d4d4d4; padding: 40px">
                ...
                <div class="form-group">
                    <label for="description">Your Status</label>
                    <input class="form-control" placeholder="Update your status" type="text" v-model="userStatus">
                </div>

                <button class="btn btn-default" style="background: black; color: white; width: 120px; height: 40px" :disabled="disableSubmit" @click="performSubmit">Save</button>
            ...
            <div class="col-md-6" style="margin-left: 100px; background: #d4d4d4; padding: 40px">
                <h3>Wallet Details</h3><hr><br><br>
